...
<head>
    ...
    <!-- Vendor -->
    <link rel="stylesheet"
        href="<?php echo e(asset('assets/vendor/libs/@form-validation/form-validation.css')); ?>" />
                            ...
                            <div class="app-brand justify-content-center mb-4 mt-2">
                                <a href="https://vioredigital.com/" class="app-brand-link gap-2">
                                    <span class="app-brand-logo demo" style="width: 100px; height: 100px">
                                        <img src="<?php echo e(asset('slims.png')); ?>" width="75" height="65" alt="Your Logo">
                                    </span>
                                </a>
                            </div>
                            <!-- /Logo -->
                            <h3 class="mb-1 pt-2" style="text-align: center!important;">Bienvenue sur Slims Digital 🚀</h3>
                            <form id="formAuthentication" class="mb-3" action="<?php echo e(route('restaurant.store')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                <div class="mb-3">
...
<?php /**PATH C:\Users\DELL\Desktop\viore_aide\resources\views/restaurant/create.blade.php ENDPATH**/ ?>