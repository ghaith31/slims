 ...
 <div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
             ...
             <thead>
                    ...
                    <tbody class="text-sm">
                    <?php $__currentLoopData = $Ordredachats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ordre): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr >                                            
                            <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5 text-gray-500">
                            <?php echo e($ordre->id); ?></td>
                            <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5 text-gray-500">
                            <?php echo e($ordre->fournisseur); ?> </td>
                            <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5 text-gray-500">
                            <?php echo e($ordre->destination); ?></td>
                            <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5 text-gray-500">
                            <?php echo e($ordre->status); ?></td>
                            <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5 text-gray-500">
                            <?php echo e($ordre->date_livraison); ?></td>
                            <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5 text-gray-500">
                            <?php echo e($ordre->created_at); ?> </td>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form class="mb-3" action="<?php echo e(route('ordre.ajout')); ?>" method="POST">
                 <?php echo csrf_field(); ?>
                        <div class="mb-3">
                        ...
                        <select class="form-control"  id="fournisseur" name ="fournisseur" >
                            <option value="">Choisir...</option>
                             <?php $__currentLoopData = $fournisseurs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fournisseur): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <option value="<?php echo e($fournisseur->Nom); ?>"><?php echo e($fournisseur->Nom); ?></option>
                              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                              </select>
...
<?php /**PATH C:\viore_aide\resources\views/admin/inventaire/ordresdachat.blade.php ENDPATH**/ ?>