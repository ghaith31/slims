...
<body>
    ...
    <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme sidebar-menu" >
        <a href="{{ route('menu.create')}} "> <img width="7%" height="7%"  fill="none" src="{{ asset('men.png')}}" class="img" style="margin-bottom: -20% !important;"></a>
         <img width="28%" height="15%" viewBox="0 0 32 22" fill="none" src="{{ asset('slims.png')}}" class="img">
                            ...
                            <div class="swiper-slide">
                                <div class="row">
                                    ...
                                    <div class="col-lg-7 col-md-9 col-12 order-2 order-md-1">
                                        ...
                                        <h6 class="text-white mt-0 mt-md-3 mb-3"><strong> Somme totale des commandes :</strong></h6>
                                                <p class="mb-0 fw-medium me-2 website-analytics-text-bg">{{ $totalSum }}</p>
