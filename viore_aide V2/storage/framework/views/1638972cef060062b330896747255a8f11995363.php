    ...
    <div class="container-xxl flex-grow-1 container-p-y">
             ...
             <tr>
              ...
              <th class="supprime th-status deleted" onclick="showNewTable()">Supprimé</th>
                    ...
                    <tr onclick="window.location='<?php echo e(route('employe.detail', ['employe' => $employe->id])); ?>';"style="cursor: pointer;">                                           
                            <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5 text-gray-500"> <?php echo e($employe->Nom); ?></td>
                            <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5 text-gray-500"><?php echo e($employe->Email); ?> </td>
                            <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5 text-gray-500"><?php echo e($employe->Rôle); ?></td>
                            <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5 text-gray-500"><?php echo e($employe->status); ?></td>   
                        </tr>
                        <?php endif; ?>
            ...
            <?php if($deletedemp->count() > 0): ?>
                    ...
                    <tbody class="text-sm">
                    <?php $__currentLoopData = $deletedemp; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employe): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form  class="mb-3" action="<?php echo e(route ('employe.store')); ?>" method="POST" id ="employeForm">
                        <?php echo csrf_field(); ?>
                            <div class="mb-3">
...
<?php /**PATH C:\wamp64\www\viore_aide\resources\views/admin/ajout.blade.php ENDPATH**/ ?>