    ...
    <div class="container-xxl flex-grow-1 container-p-y">
             ...
             <thead>
                    ...
                    <?php $__currentLoopData = $branches; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $branche): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                           <tr onclick="window.location='<?php echo e(route('branche.detail', ['branche' => $branche->id])); ?>';" style="cursor: pointer;">
                           <td><input type="checkbox" class="dt-checkboxes-select-all form-check-input"> </th>
                            <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5 text-gray-500"><?php echo e($branche->Nom); ?></td>
                            <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5 text-gray-500"><?php echo e($branche->référence); ?></td>
                            <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5 text-gray-500"><?php echo e($branche->tax_groupe); ?> </td>
                            <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5 text-gray-500"><?php echo e($branche->created_at); ?> </td>                           
                        </tr>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form class="mb-3" action="<?php echo e(route('branche.ajout')); ?>" method="POST" id ="brancheForm">
                 <?php echo csrf_field(); ?>
                <div class="mb-3">
...
<?php /**PATH C:\viore_aide\resources\views/admin/mange/branche.blade.php ENDPATH**/ ?>