 ...
 <div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <tbody class="bg-white">
          <?php $__currentLoopData = $tousOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr onclick="window.location='<?php echo e(route('option.detail', ['option' => $option->id])); ?>';" style="cursor: pointer;">  
                <td><input type="checkbox" class="dt-checkboxes form-check-input"></td>
                <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5 text-gray-500"><?php echo e($option->Nom); ?></td>
                <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5 text-gray-500"><?php echo e($option->SKU); ?></td>
                <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5 text-gray-500"><?php echo e($option->modify->Nom); ?></td>
                <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5 text-gray-500"><?php echo e($option->prix); ?></td>
                <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5 text-gray-500"><?php echo e($option->groupe_impot); ?></td>
                <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5 text-gray-500"><?php echo e($option->statut); ?></td>
            </tr>
    ...
    <table class="datatables-customers table border-top" id="newTable" style="display: none;">
        ...
        <tbody class="table-body">
          <?php $__currentLoopData = $deletedOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr onclick="window.location='<?php echo e(route('option.detail', ['option' => $option->id])); ?>';" style="cursor: pointer;">     
                <td><input type="checkbox" class="dt-checkboxes form-check-input"></td>
                <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5 text-gray-500"><?php echo e($option->Nom); ?></td>
                <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5 text-gray-500"><?php echo e($option->SKU); ?></td>
    ...
    <table class="datatables-customers table border-top" id="activeTable" style="display: none;">
        ...
        <tbody class="table-body">
          <?php $__currentLoopData = $actifOption; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr onclick="window.location='<?php echo e(route('option.detail', ['option' => $option->id])); ?>';" style="cursor: pointer;">     
                <td><input type="checkbox" class="dt-checkboxes form-check-input"></td>
                <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5 text-gray-500"><?php echo e($option->Nom); ?></td>
                <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5 text-gray-500"><?php echo e($option->SKU); ?></td>
    ...
    <table class="datatables-customers table border-top" id="inactiveTable" style="display: none;">
        ...
        <tbody class="table-body">
          <?php $__currentLoopData = $inactifOption; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr onclick="window.location='<?php echo e(route('option.detail', ['option' => $option->id])); ?>';" style="cursor: pointer;">     
                <td><input type="checkbox" class="dt-checkboxes form-check-input"></td>
                <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5 text-gray-500"><?php echo e($option->Nom); ?></td>
                <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5 text-gray-500"><?php echo e($option->SKU); ?></td>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form class="mb-3" action="<?php echo e(route('optionmodif.ajout')); ?>" method="POST" id="optionForm">
                 <?php echo csrf_field(); ?>
                <div class="mb-3">
                ...
                <select class="form-control" id="modificateurr" name="modificateur">
                          <option value="">Choisir...</option>
                           <?php $__currentLoopData = $modif; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $modif): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($modif->Nom); ?>"><?php echo e($modif->Nom); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
...
<?php /**PATH C:\wamp64\www\viore_aide\resources\views/admin/menu/optionmodificateur.blade.php ENDPATH**/ ?>