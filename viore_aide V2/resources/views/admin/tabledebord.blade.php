      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme sidebar-menu" >
          <a href="{{ route('menu.create')}} "> <img width="7%" height="7%"  fill="none" src="{{ asset('men.png')}}" class="img" style="margin-bottom: -20% !important;"></a>
           <img width="50%" height="6%" viewBox="0 0 32 22" fill="none" src="{{ asset('slims.png')}}" class="img1">
...
<a href="{{ route('admin.index') }}" class="menu-link">
    ...
    <div class="menu-item  ">Commands</div>
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
              <img src="{{ asset('assets/icons/settings.png')}}" alt="Votre Logo" class="menu-logo" style="width: 20px; height: 20px;"> 
                <div >Manage</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="{{route('employe.affich')}}" class="menu-link">
                    <div>Utilisateurs</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="{{route('branche.affich')}}"  class="menu-link">
                    <div>Branche</div>
                  </a>
                </li>

                <li class="menu-item">
                  <a href="{{route('reduction.affich')}}" class="menu-link">
                    <div>Réductions</div>
                  </a>
                </li>
              </ul>
                        ...
                        <div class="col-12">
                            <div class="row">
                                <div class="col-lg-3 col-md-6 col-sm-12">
                                    ...
                                    <p class="text-black mt-4 mb-3">{{ $totalOrders }}</p>
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-12">
                                    ...
                                    <p class="text-black mt-4 mb-3">{{ $totalSum }}</p>
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-12"   >
                                    ...
                                    <ul class="list-unstyled mb-0">
                                        @foreach($orderCountsByDay as $date => $count)
                                            <li class="text-black mt-4 mb-3">{{ $date }}: {{ $count->count }} orders</li>
                                        @endforeach
                                    </ul>
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-12">
                                    ...
                                    <ul class="list-unstyled mb-0">
                                        @foreach($orderCountsByMonth as $month)
                                            <li class="text-black mt-4 mb-3">{{ $month['label'] }}: {{ $month['count'] }} orders</li>
                                        @endforeach
                                    </ul>
    ...
    var ordersByDayData = [];
    @foreach($orderCountsByDay as $date => $count)
        ordersByDayLabels.push('{{ $date }}');
        ordersByDayData.push({{ $count->count }});
    @endforeach
    ...
    @foreach($orderCountsByMonth as $month)
        ordersByMonthLabels.push('{{ $month['label'] }}');
        ordersByMonthData.push({{ $month['count'] }});
    @endforeach
