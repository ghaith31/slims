...
<style>
    .subcategories {
        ...
        top: 0;
        left: 18%;
        /* Déplace le conteneur à partir du milieu */
        transform: translateX(-40%);
        transform: translateY(30%);
        /* Centre le conteneur horizontalement */
        background-color: white;
        /* Fond blanc pour le cadre */
        padding: 10px;
        ...
        flex-wrap: wrap;
        /* Permettre le passage à la ligne automatique */
        justify-content: flex-end;
        /* Centrer les éléments sur l'axe principal */
    }

    @media (max-width: 767px) {
            .subcategories {
                left: 40%; /* Valeur pour les écrans mobiles */
            }
        }
    ...
    height: 90%; /* Change this to auto to make it as tall as its content */
    max-height: 100%; /* Optional: restrict maximum height */
    overflow-y: auto; /* Change overflow-x to overflow-y for vertical scrolling */
    margin-bottom: 0;
}
    ...
    #panier ul {
        ...
        padding: 0;
        margin: auto;
        /* Centre le panier horizontalement */
        width: 80%;
        /* Ajoutez une largeur appropriée selon votre mise en page */
        max-width: 1000px;
        /* Limitez la largeur maximale du panier */
    }
    ...
    .cart-item-price {
        margin-top: 5px;
        /* Espacement entre le nom et le prix */
    }
    ...
    .cart-item-image {
        ...
        /* Coins arrondis */
        overflow: hidden;
        /* Masque les parties supplémentaires de l'image */
    }

    .cart-item-image img {
        width: 100%;
        /* Pour s'assurer que l'image remplit entièrement le conteneur */
        height: auto;
        /* Pour maintenir le rapport hauteur/largeur de l'image */
        object-fit: cover;
        /* Redimensionne l'image pour remplir le conteneur tout en conservant son rapport d'aspect */
...
<div class="layout-page">
    ...
    <?php echo $__env->make('admin.nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        ...
        <div class="subcategories">
            ...
            <div data-nom="<?php echo e($product->Nom); ?>" data-id="<?php echo e($product->id); ?>" data-prix="<?php echo e($product->Prix); ?>">
                <!-- Formulaire pour ajouter au panier -->
                <form action="<?php echo e(route('cart.add')); ?>" method="POST" style="display: none;">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="productId" value="<?php echo e($product->id); ?>">
                    <input type="hidden" name="productName" value="<?php echo e($product->Nom); ?>">
                    <input type="hidden" name="productPrice" value="<?php echo e($product->Prix); ?>">
                    <input type="hidden" name="productImage" value="<?php echo e($product->photo); ?>">
                </form>
                <!-- Bouton pour ajouter au panier -->
                <button type="button" class=" add-to-cart subcategory-square">
                    <!-- Image du produit -->
                    <div>
                        <img src="<?php echo e(asset( $product->photo)); ?>" width="100px" height="80px" class="img img-responsive">
                    </div>
                    <!-- Nom et prix du produit -->
                    <div>
                        <div><?php echo e($product->Nom); ?></div>
                        <div><?php echo e($product->Prix); ?> €</div>
                    </div>
                </button>
            </div>
        ...
        <div id="panier" style="text-align: center !important;">
            ...
            <ul>
                ...
                <?php $__currentLoopData = session('cart'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $productId => $cartItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li class="cart-item">
                    <!-- Conteneur pour l'image, le nom et le prix -->
                    <div class="cart-item-content">
                        <!-- Image du produit -->
                        <div class="cart-item-image" style="justify-content: centre !important;">
                            <img src="<?php echo e(asset($cartItem['product']->photo)); ?>" alt="menu" class="img-fluid">
                        </div>
                        <!-- Informations sur le produit -->
                        <div class="cart-item-info" style=" flex-grow: 1;">
                            <!-- Nom du produit -->
                            <h3 class="cart-item-title"><?php echo e($cartItem['product']->Nom); ?></h3>
                            <!-- Prix du produit -->
                            <p class="cart-item-price"><?php echo e($cartItem['product']->Prix); ?> €</p>
                        </div>
                    </div>
                    <!-- Boutons pour augmenter et diminuer la quantité -->
                    <div class="cart-item-quantity">
                        <button class="quantity-button" onclick="updateCartQuantity('<?php echo e($productId); ?>', 'minus')">-</button>
                        <span id="quantity_<?php echo e($productId); ?>" class="quantity-value"><?php echo e(session('clicks')[$productId] ?? 0); ?></span>
                        <button class="quantity-button" onclick="updateCartQuantity('<?php echo e($productId); ?>', 'plus')">+</button>
                    </div>
            ...
            <p class="subtotal">Sous-total <span><?php echo e($totalPrice); ?> €</span></p>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <form id="command-form" action="<?php echo e(route('save.command')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        ...
                        <?php if(session('cart')): ?>
                        <?php $__currentLoopData = session('cart'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $productId => $cartItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <input type="hidden" name="produits[<?php echo e($productId); ?>]" value="<?php echo e(session('clicks')[$productId] ?? 0); ?>"> <!-- Utilisez [] pour créer un tableau de valeurs -->
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php endif; ?>
                        ...
                        <ul>
                            ...
                            <ul>
                                <?php $__currentLoopData = session('cart'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $productId => $cartItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li>
                                    <?php echo e($cartItem['product']->Nom); ?> - Quantité: <?php echo e(session('clicks')[$productId] ?? 0); ?>
...
</html><?php /**PATH C:\viore_aide\resources\views/admin/menuprod.blade.php ENDPATH**/ ?>