...
<html
  ...
  <head>
    ...
    <title>eCommerce Customer Details Overview - Pages | Vuexy - Bootstrap Admin Template</title>
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <form action="{{route('logout')}}" method="post">
                        @csrf
                        <button class="dropdown-item"><i class="ti ti-logout me-2 ti-sm"></i> <span class="align-middle">Log Out</span></button>
              ...
              <div class="row">
                ...
                <div class="col-xl-4 col-lg-5 col-md-5 order-1 order-md-0">
                      ...
                      <div class="info-container">
                        ...
                        <ul class="list-unstyled">
                          <li class="mb-3">
                            ...
                            <span>{{ $restaurants->customerName }}</span>
                          </li>
                          <li class="mb-3">
                            <span class="fw-medium me-2">Email:</span>
                            <span>{{ $restaurants->customerEmail }}</span>
                          </li>
                          <li class="mb-3">
                          ...
                          <li class="mb-3">
                            ...
                            <span>{{ $restaurants->customerContact }}</span>
                          </li>

                          <li class="mb-3">
                            <span class="fw-medium me-2">Country:</span>
                            <span>{{ $restaurants->pays}}</span>
                          </li>
                        </ul>
                  ...
                  <div class="card mb-4 bg-gradient-primary">
                    <div class="card-body">
                      ...
                      <button
                        class="btn btn-white text-primary w-100 fw-medium shadow-md"
                ...
                <div class="col-xl-8 col-lg-7 col-md-7 order-0 order-md-1">
                  ...
                  <ul class="nav nav-pills flex-column flex-md-row mb-3">
                    <li class="nav-item">
                      <a class="nav-link active py-2" href="javascript:void(0);"
                        ><i class="ti ti-user me-1"></i>Overview</a
                      >
                    </li>
                    <li class="nav-item">
                      <a class="nav-link py-2" href="app-ecommerce-customer-details-security.html"
                        ><i class="ti ti-lock me-1"></i>Security</a
                      >
                    </li>
                    <li class="nav-item">
                      <a class="nav-link py-2" href="app-ecommerce-customer-details-billing.html"
                        ><i class="ti ti-file-invoice me-1"></i>Address & Billing</a
                      >
                    </li>
                    <li class="nav-item">
                      <a class="nav-link py-2" href="app-ecommerce-customer-details-notifications.html"
                        ><i class="ti ti-bell me-1"></i>Notifications</a
                      >
                    </li>
                  </ul>
                  <!--/ Customer Pills -->
