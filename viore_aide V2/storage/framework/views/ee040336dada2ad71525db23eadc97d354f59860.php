      ...
      <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div  class="button-heading-container">
            ...
            <?php endif; ?>
                            ...
                            <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5 text-gray-500">
                            <?php echo e($categorie->Référence); ?></td>
                            <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5 text-gray-500">
                            Produit (<?php echo e($categorie->Produit); ?> )</td>
                            <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5 text-gray-500">
                            Combinaisons (<?php echo e($categorie-> Combinaisons); ?> )</td>
                                <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5 text-gray-500">
                            Cartes cadeaux (<?php echo e($categorie-> Cartes_cadeau); ?>)</td>
                            <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5 text-gray-500">
                            <?php echo e($categorie-> created_at); ?> </td>   
                        </tr>
...
</html><?php /**PATH C:\wamp64\www\viore_aide\resources\views/admin/categorie.blade.php ENDPATH**/ ?>