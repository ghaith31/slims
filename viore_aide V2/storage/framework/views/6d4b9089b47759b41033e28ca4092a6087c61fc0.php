          ...
          <ul class="navbar-nav flex-row align-items-center ms-auto">
              <li class="nav-item dropdown-notifications navbar-dropdown dropdown me-3 me-xl-1">
                  <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
                      <i class="ti ti-md"><img src="<?php echo e(asset('assets/img/notifi.png')); ?>" width="20px" alt="Logo d'e-mail" /></i>
                      <?php
                          ...
                          <ul class="list-group list-group-flush">
                              <?php if(auth()->check() && auth()->user()->unreadNotifications->count() > 0): ?>
                                  <?php $__currentLoopData = auth()->user()->unreadNotifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                      <li class="list-group-item list-group-item-action dropdown-notifications-item" data-notification-id="<?php echo e($notification->id); ?>">
...
</script><?php /**PATH C:\wamp64\www\viore_aide\resources\views/layouts/navbar.blade.php ENDPATH**/ ?>