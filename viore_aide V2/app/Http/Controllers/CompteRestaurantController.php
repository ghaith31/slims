    ...
    public function ajout(ProduitRequest $request)
{
    ...
    public function detailCategorieP($categorieId) {
        // Logique pour récupérer les détails de la catégorie principale avec l'ID $id
        $categorie = Categoriep::findOrFail($categorieId); // Exemple
    
        return view('admin.menu.detailCategorieP', compact('categorie'));
    }
