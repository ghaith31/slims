      ...
      <div class="container">
        <div class="navbar navbar-expand-lg landing-navbar px-3 px-md-4">
          ...
          <ul class="navbar-nav flex-row align-items-center ms-auto">
            <li>
              <a href="<?php echo e(route('restaurant.create')); ?>" class="btn btn-primary" target="_blank"
                ></span
                          ...
                          <div class="row">
                            ...
                            Slims Digital</h1>
                                      ...
                                      <ul class="d-flex flex-wrap">
                                          <li><a class="common_btn" href="<?php echo e(route('restaurant.create')); ?>">rejoingrez-nous</a></li>
                                      </ul>
                                  </div>
                              </div>
                          </div>
...
<?php /**PATH C:\Users\DELL\Desktop\viore_aide\resources\views/welcome.blade.php ENDPATH**/ ?>