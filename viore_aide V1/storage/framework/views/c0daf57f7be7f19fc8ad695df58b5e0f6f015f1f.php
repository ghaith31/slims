        ...
        <div class="authentication-inner py-4">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- /Logo -->
              <div class="app-brand justify-content-center mb-4 mt-2" style="width: 300px;">
    <a href="index.html" class="app-brand-link gap-2">
        <!-- Utilisation de la balise img avec l'image de votre PC -->
        <span style="width: 100%; height: 100px;" class="app-brand-logo demo">
            <img src="slims.png" width="100" height="60" alt="Your Logo">
        </span>
    </a>
</div>
              ...
              <?php echo csrf_field(); ?>
                <div class="mb-3">
                  <label for="username" :value="__('Name')" class="form-label" >Name :</label>
                  <input
                    type="text"
                    class="form-control"
                    id="name"
...
<?php endif; ?>
                ...
                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.primary-button','data' => ['class' => 'btn btn-primary d-grid w-100']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'btn btn-primary d-grid w-100']); ?>
...
<?php endif; ?>
              ...
              <div class="d-flex justify-content-center">
                <a href="https://www.facebook.com/viore.digital/" class="btn btn-icon btn-label-facebook me-3">
...
<?php /**PATH C:\wamp64\www\viore_aide\resources\views/layouts/auth-register.blade.php ENDPATH**/ ?>