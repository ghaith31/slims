    ...
    <div class="container-xxl flex-grow-1 container-p-y">
             ...
             <thead>
                    <tr>
                     ...
                     <?php $__currentLoopData = $touscarte; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $carte): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                     <tr onclick="window.location='<?php echo e(route('carte.detail', ['carte' => $carte->id])); ?>';" style="cursor: pointer;">                                                
                            <td><input type="checkbox" class="dt-checkboxes form-check-input"></td>                    
                           <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5 text-gray-500">
                            <img src="<?php echo e($carte->photo); ?>" width ="50"height ="50"class ="img img-responsive"/></td>                     
                            <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5 text-gray-500"><?php echo e($carte->Nom); ?></td>
                            <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5 text-gray-500"><?php echo e($carte->SKU); ?></td>
                            <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5 text-gray-500"><?php echo e($carte->category->Nom); ?></td>
                            <?php if($carte->strategie_prix === 'Prix libre'): ?>
                            <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5 text-gray-500">Prix libre</td>
                        <?php else: ?>
                            <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5 text-gray-500"><?php echo e($carte->Prix); ?></td>
                        <?php endif; ?>
                            <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5 text-gray-500"><?php echo e($carte->status); ?> </td>                          
                        </tr>
             ...
             <thead>
                    <tr>
                     ...
                     <tbody class="bg-white">
                     <?php $__currentLoopData = $deletedCarte; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $carte): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                     <tr onclick="window.location='<?php echo e(route('carte.detail', ['carte' => $carte->id])); ?>';" style="cursor: pointer;">                                                
                            <td><input type="checkbox" class="dt-checkboxes form-check-input"></td>                    
                           <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5 text-gray-500">
                            <img src="<?php echo e($carte->photo); ?>" width ="50"height ="50"class ="img img-responsive"/></td>                     
             ...
             <thead>
                    <tr>
                     ...
                     <tbody class="bg-white">
                     <?php $__currentLoopData = $actifCarte; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $carte): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                     <tr onclick="window.location='<?php echo e(route('carte.detail', ['carte' => $carte->id])); ?>';" style="cursor: pointer;">                                                
                            <td><input type="checkbox" class="dt-checkboxes form-check-input"></td>                    
                           <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5 text-gray-500">
                            <img src="<?php echo e($carte->photo); ?>" width ="50"height ="50"class ="img img-responsive"/></td>                     
             ...
             <thead>
                    <tr>
                     ...
                     <tbody class="bg-white">
                     <?php $__currentLoopData = $inactifCarte; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $carte): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                     <tr onclick="window.location='<?php echo e(route('carte.detail', ['carte' => $carte->id])); ?>';" style="cursor: pointer;">                                                
                            <td><input type="checkbox" class="dt-checkboxes form-check-input"></td>                    
                           <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5 text-gray-500">
                            <img src="<?php echo e($carte->photo); ?>" width ="50"height ="50"class ="img img-responsive"/></td>                     
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form class="mb-3" action="<?php echo e(route('cartefidelite.ajout')); ?>" method="POST" enctype="multipart/form-data" id ="carteForm">
                 <?php echo csrf_field(); ?>
                        <div class="mb-3">
...
<?php /**PATH C:\viore_aide\resources\views/admin/menu/cartecadeau.blade.php ENDPATH**/ ?>