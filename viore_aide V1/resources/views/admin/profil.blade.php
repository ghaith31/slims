                  ...
                  <div class="card mb-4">
                    ...
                    <div class=" d-flex flex-column flex-sm-row text-sm-start text-center mb-4">
                      <div class="flex-shrink-0 mt-n2 mx-sm-0 mx-auto">
                        <img src="{{ asset(  $employe->photo) }}"  class="img img-responsive" />
                      </div>
                        ...
                        <div
                          ...
                          <div class="user-profile-info">
                            ...
                            <ul
                              ...
                              <li class="list-inline-item d-flex gap-1"><i class="ti ti-map-pin"></i>{{ $employe->pays}}</li>
                              <li class="list-inline-item d-flex gap-1">
                    ...
                    <div class="card-body">
                      ...
                      <ul class="list-unstyled mb-4 mt-3">
                        ...
                        <li class="d-flex align-items-center mb-3">
                          ...
                          ><span class="fw-medium mx-2 text-heading">Rôle:</span> <span>{{ $employe->Rôle}}</span>
                        </li>
                        <li class="d-flex align-items-center mb-3">
